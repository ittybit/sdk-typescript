...
<details><summary><code>client.automations.<a href="/src/api/resources/automations/client/Client.ts">list</a>({ ...params }) -> Ittybit.AutomationsListResponseItem[]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.files.<a href="/src/api/resources/files/client/Client.ts">list</a>({ ...params }) -> Ittybit.FilesListResponseItem[]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.tasks.<a href="/src/api/resources/tasks/client/Client.ts">list</a>({ ...params }) -> Ittybit.TasksListResponseItem[]</code></summary>
<dl>
<dd>
