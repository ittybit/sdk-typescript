...
export interface MediaCreateResponse {
    meta?: MediaCreateResponse.Meta;
    data?: MediaCreateResponse.Data;
    error?: MediaCreateResponse.Error_;
    links?: MediaCreateResponse.Links;
}

export namespace MediaCreateResponse {
