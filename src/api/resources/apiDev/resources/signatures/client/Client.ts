...
export class Signatures {
     ...
     *
     * @param {Ittybit.apiDev.SignaturesCreateRequest} request
    ...
    ): core.HttpResponsePromise<Ittybit.apiDev.SignaturesCreateResponse> {
    ...
    private async __create(
        request: Ittybit.apiDev.SignaturesCreateRequest,
        requestOptions?: Signatures.RequestOptions,
    ): Promise<core.WithRawResponse<Ittybit.apiDev.SignaturesCreateResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Ittybit.apiDev.SignaturesCreateResponse,
