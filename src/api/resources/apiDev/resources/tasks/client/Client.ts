...
export class Tasks {
     ...
     *
     * @param {Ittybit.apiDev.TasksListRequest} request
    ...
    ): core.HttpResponsePromise<Ittybit.apiDev.TasksListResponseItem[]> {
    ...
    private async __list(
        request: Ittybit.apiDev.TasksListRequest = {},
        requestOptions?: Tasks.RequestOptions,
    ): Promise<core.WithRawResponse<Ittybit.apiDev.TasksListResponseItem[]>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Ittybit.apiDev.TasksListResponseItem[],
    ...
    public create(
        request?: unknown,
        requestOptions?: Tasks.RequestOptions,
    ): core.HttpResponsePromise<Ittybit.apiDev.TasksCreateResponse> {
    ...
    private async __create(
        request?: unknown,
        requestOptions?: Tasks.RequestOptions,
    ): Promise<core.WithRawResponse<Ittybit.apiDev.TasksCreateResponse>> {
        var _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                Authorization: await this._getAuthorizationHeader(),
        ...
        if (_response.ok) {
            return { data: _response.body as Ittybit.apiDev.TasksCreateResponse, rawResponse: _response.rawResponse };
        }
    ...
    public get(
        id: string,
        requestOptions?: Tasks.RequestOptions,
    ): core.HttpResponsePromise<Ittybit.apiDev.TasksGetResponse> {
    ...
    private async __get(
        id: string,
        requestOptions?: Tasks.RequestOptions,
    ): Promise<core.WithRawResponse<Ittybit.apiDev.TasksGetResponse>> {
        var _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                Authorization: await this._getAuthorizationHeader(),
        ...
        if (_response.ok) {
            return { data: _response.body as Ittybit.apiDev.TasksGetResponse, rawResponse: _response.rawResponse };
        }
