...
export class Automations {
     ...
     *
     * @param {Ittybit.apiDev.AutomationsListRequest} request
    ...
    ): core.HttpResponsePromise<Ittybit.apiDev.AutomationsListResponseItem[]> {
    ...
    private async __list(
        request: Ittybit.apiDev.AutomationsListRequest = {},
        requestOptions?: Automations.RequestOptions,
    ): Promise<core.WithRawResponse<Ittybit.apiDev.AutomationsListResponseItem[]>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Ittybit.apiDev.AutomationsListResponseItem[],
     ...
     *
     * @param {Ittybit.apiDev.AutomationsCreateRequest} request
     * @param {Automations.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public create(
        ...
        requestOptions?: Automations.RequestOptions,
    ): core.HttpResponsePromise<Ittybit.apiDev.AutomationsCreateResponse> {
    ...
    private async __create(
        request: Ittybit.apiDev.AutomationsCreateRequest,
        requestOptions?: Automations.RequestOptions,
    ): Promise<core.WithRawResponse<Ittybit.apiDev.AutomationsCreateResponse>> {
        var _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                Authorization: await this._getAuthorizationHeader(),
        ...
        if (_response.ok) {
            return {
                data: _response.body as Ittybit.apiDev.AutomationsCreateResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    public get(
        id: string,
        requestOptions?: Automations.RequestOptions,
    ): core.HttpResponsePromise<Ittybit.apiDev.AutomationsGetResponse> {
    ...
    private async __get(
        id: string,
        requestOptions?: Automations.RequestOptions,
    ): Promise<core.WithRawResponse<Ittybit.apiDev.AutomationsGetResponse>> {
        var _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                Authorization: await this._getAuthorizationHeader(),
        ...
        if (_response.ok) {
            return {
                data: _response.body as Ittybit.apiDev.AutomationsGetResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    public delete(
        id: string,
        requestOptions?: Automations.RequestOptions,
    ): core.HttpResponsePromise<Ittybit.apiDev.AutomationsDeleteResponse> {
    ...
    private async __delete(
        id: string,
        requestOptions?: Automations.RequestOptions,
    ): Promise<core.WithRawResponse<Ittybit.apiDev.AutomationsDeleteResponse>> {
        var _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                Authorization: await this._getAuthorizationHeader(),
        ...
        if (_response.ok) {
            return {
                data: _response.body as Ittybit.apiDev.AutomationsDeleteResponse,
                rawResponse: _response.rawResponse,
            };
        }
     ...
     *
     * @param {string} id
     * @param {Ittybit.apiDev.AutomationsUpdateRequest} request
     * @param {Automations.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public update(
        ...
        requestOptions?: Automations.RequestOptions,
    ): core.HttpResponsePromise<Ittybit.apiDev.AutomationsUpdateResponse> {
    ...
    private async __update(
        ...
        request: Ittybit.apiDev.AutomationsUpdateRequest = {},
        requestOptions?: Automations.RequestOptions,
    ): Promise<core.WithRawResponse<Ittybit.apiDev.AutomationsUpdateResponse>> {
        var _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                Authorization: await this._getAuthorizationHeader(),
        ...
        if (_response.ok) {
            return {
                data: _response.body as Ittybit.apiDev.AutomationsUpdateResponse,
                rawResponse: _response.rawResponse,
            };
        }
